...
class UrineAnalysisRequestForm(forms.Form):
    ...
    leukocyte = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    ...
    urbilonogen = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    ...
    mleukocytes = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    merythrocytes = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    ...
    squamous_epithelial_cells = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    hyaline_casts = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    granular_cast = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    wbc_cast = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    rbc_ast = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    ...
    triplate_phosphate = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))

class StoolExaminationRequestForm(forms.Form):
    parasites=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    puss_cell=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    ...
    obt=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    Hpylori_test=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))


class HematologyExaminationRequestForm(forms.Form):
    cbc=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    bc=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    twc=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    differntial=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    neutrophil=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    eosinophil=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    ...
    hemoglobin=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    ...
    esr=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    bleeding_time_test=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    clot_reaction=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    coagulation_time=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    prothromin_time=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    p_t_t=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    ...
    coomos_test=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
    cd4=forms.BooleanField(required=False,widget=forms.CheckboxInput(attrs={'class': 'form-control'}))

class X_ray_Request_Form(forms.Form):
...
class Ultrasound_Request_Form(forms.Form):
    organ_to_be_examined=forms.CharField(required=True,widget=forms.Textarea(attrs={'class':'form-control'}))

class Administred_Treatment_Form(forms.Form):
    medication_name=forms.CharField(required=True,max_length=150,widget=forms.TextInput(attrs={'class':'form-control'}))
    medication_description=forms.CharField(required=True,widget=forms.Textarea(attrs={'class':'form-control'}))