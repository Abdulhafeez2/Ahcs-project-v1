...
class UrineAnalysisRequestForm(forms.Form):
    ...
    microscopy_leukocyte = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))
...
class StoolExaminationRequestForm(forms.Form):
    parasites = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control' 'checkbox'}))
    ...
    h_pylory_stool_ag_test = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control'}))


class HematologyExaminationRequestForm(forms.Form):
    cbc = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={'class': 'form-control' 'fancy-checkbox'}))
