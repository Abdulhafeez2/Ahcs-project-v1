    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x_ray_image', models.ImageField(blank=True, null=True, upload_to='images/')),
                ...
                ('requested_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='xray_requested_to', to='accounts.staff')),
            ],
        ),
        migrations.CreateModel(
            name='VitalSign',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requested_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='urine_requested_to', to='accounts.staff')),
            ],
        ),
        migrations.CreateModel(
            name='UltraSound',
            fields=[
                ...
                ('date_of_request', models.DateTimeField(auto_now_add=True)),
                ('ultra_sound_image', models.ImageField(blank=True, null=True, upload_to='images/')),
                ...
                ('requested_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ultrasound_requested_to', to='accounts.staff')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requested_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stool_requested_to', to='accounts.staff')),
            ],
        ),
        migrations.CreateModel(
            name='Prescription',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requested_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hematology_requested_to', to='accounts.staff')),
            ],
        ),
        migrations.CreateModel(
